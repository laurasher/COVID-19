...
def main():
    ...
    out_file_new_daily_cases = "../visuals/choropleth/choropleth_covid_plot_new_daily_cases_650px.html"
    moving_window = 5
    ...
    toggl_js = CustomJS(args=dict(slider=timeslider_new_daily_cases, end=[i for i in range(1, num_days)]),
        code="""
    ...
    layout_new_daily_cases = column(p2, timeslider_new_daily_cases, widgetbox(toggl, width=100))
    ...
    ############## USER PARAMS ##############
    # Write output file to...
    out_file_new_daily_cases = "../visuals/choropleth/choropleth_covid_plot_new_daily_cases_320px.html"
    moving_window = 5
